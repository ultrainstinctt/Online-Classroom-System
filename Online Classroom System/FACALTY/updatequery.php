	...
	<div class="row">
      ...
      if (!$conn)
	  {
          die("Sorry we failed to connect: ". mysqli_connect_error());
				...
				$editid=$_GET['gid'];
				$sql="select * from query where eid=$editid";
			...
			if ( isset( $_POST[ 'update' ] ) ) {
				...
				$sql = "UPDATE `query` SET Query='$tempquery', Ans='$tempans' WHERE eid='$editid'";
				if ( mysqli_query( $conn, $sql ) ) {
					...
					echo "<br><Strong>Query Details Updating Faliure. Try Again</strong><br> Error Details: " . $sql . "<br>" . mysqli_error( $conn );
				}
